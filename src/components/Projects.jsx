            ...
            <div key={pro} className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden sm:max-w-xl md:max-w-xl">
              <div className="md:flex">
                <div className="md:flex-shrink-0">
                  <img className="h-48 w-full object-cover md:w-48" src={pro.img} alt={pro.img} />
                </div>
                <div className="p-8">
                  <a href={pro.url} className="block mt-1 text-lg leading-tight font-medium text-black hover:underline">{pro.Title}</a>
